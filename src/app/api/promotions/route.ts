...
export async function POST(req: Request) {
  ...
  const FORBIDDEN_EXT = new Set(["php","phtml","php3","php4","php5","phar","jsp","asp","aspx","exe","sh","bat","cmd","js","mjs","cjs","pl","py"]);
  ...
  function detectMime(b: Uint8Array): string | null {
    ...
    if (b.length > 6 && String.fromCharCode(b[0],b[1],b[2],b[3],b[4],b[5]).startsWith("GIF8")) return "image/gif";
    return null;
  }
  ...
  return NextResponse.json(
    { id: created.id },
    {
      ...
      headers: {
        "Access-Control-Allow-Origin": ORIGIN,
        "Vary": "Origin",
        // 🔧 fix wrong path: should be /api/promotions
